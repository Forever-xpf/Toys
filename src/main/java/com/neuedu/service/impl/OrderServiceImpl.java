...
public class OrderServiceImpl implements IOrderService {
    ...
    /*
     *将Order对象转成OrderVO对象
     * 参数：Order order,List<OrderItem> orderItemList,Integer shippingId
     */
...
//保存订单
    ...
    @Override
    public ServerResponse aplipay_callback(Map<String, String> map) {
        ...
        if(order.getStatus()>=Const.OrderStatusEnum.ORDER_PAYED.getCode()){
            //防止支付宝重复回调
            return ServerResponse.serverResponseByError("支付宝重复回调");
        }
...
//////////////////////////////支付接口///////////////////////////////////////////////
    ...
    public ServerResponse  pay(Order order) throws IOException {
        ...
        String subject = "订单："+order.getOrderNo()+"当面付扫码消费"+order.getPayment().doubleValue();
        ...
        String body = "购买商品共"+order.getPayment().doubleValue()+"元";
       ...
       List<OrderItem> orderItemList= orderItemMapper.selectByOrderNo(order.getOrderNo());
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl(" http://39.105.28.177:8080/Wanjucheng/order/alipay_callback.do")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
               // String filePath = String.format("G:/ftpfile/qr-%s.png",
